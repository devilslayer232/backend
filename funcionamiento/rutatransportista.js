...
router.get("/", async (req, res) => {
  try {
    ...
    console.error("Error obteniendo ubicaciones_transportista:", error);
...
router.get("/:id", async (req, res) => {
  try {
    ...
    console.error("Error obteniendo ubicaciones_transportista por ID:", error);
    res.status(500).json({ error: "Error interno del servidor" });
  }
});
...
router.post("/", async (req, res) => {
  try {
    ...
    console.error("Error creando ubicaciones_transportista:", error);
    res.status(500).json({ error: "Error interno del servidor" });
  }
});
...
router.put("/:id", async (req, res) => {
  try {
    ...
    console.error("Error actualizando ubicaciones_transportista:", error);
    res.status(500).json({ error: "Error interno del servidor" });
  }
});
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    console.error("Error eliminando ubicaciones_transportista:", error);
    res.status(500).json({ error: "Error interno del servidor" });
  }
});
